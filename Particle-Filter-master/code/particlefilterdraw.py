...
class particleFilter(object):
    ...
    def particleFilterAlgo(self, XPrev, uCurrent, uPrev, zCurrent):
        ...
        for n in range(self.N):
            ...
            wtCurrent[n] = measurementModel.beamRangeFinderModel(zCurrent, XCurrentBar[n], self.occGrid,
                                                                 self.downSample, self.resolution, self.offset)
